...
"<h4>Overview</h4>" +
"<p>This project idea is about a theoretical design called The Courtesy light. The Courtesy light is a small, simple, and sleek LED that displays “Thanks” or “Sorry” when activated by a simple press of a button mounted somewhere convenient in the driver’s seat compartment. The Courtesy light will also include customization via an app connected through Bluetooth. Throughout the following report the project will discuss in detail about the individual aspects of the design, features, and software. In addition, the report will evaluate the feasibility and required skills to allow this project to be a reality. Furthermore, the report will outline the impacts that the Courtesy light would create if it were to be introduced to the public.   </p>" +

"<h4>Motivation</h4>" +
"<p>A road rage survey was conducted by Budget Direct in 2021 with results showing that 45% of Australians have admitted to showing signs of road rage with 75% of Australians being a victim of road rage (Budget Direct 2021). Whether we like it or not almost every vehicle owner has at least once been the subject of road rage, however, occasionally someone will show some courtesy on the road. Whether that be letting someone in or giving way or you may have left something on top of the car. Regardless of the situation we all get a sense of appreciation and think to ourselves I wish I could at least say ‘’Thanks/Sorry” to brighten up the fellow commuter’s day. In our current modern-day society, the use of cars has drastically expanded our capacity to travel. This is evident as according to (Kemp 2022), there are currently 1.446 billion cars on the road as of 2022.  Therefore, this provides a vast extensive market for the use of a small, simple, and sleek LED that displays “Thanks” or “Sorry” when activated by a simple press of a button mounted somewhere convenient in the driver’s seat compartment.   </p>" +

"<h4>Description</h4>" +
"<p>The product LED “Thanks/Sorry” display can be called Courtesy light for short. The Courtesy light’s two main features is an LED display that will either display Sorry or Thanks. This will be activated using two simple buttons, one button will display Sorry and the other Thanks. Furthermore, an app will be available for personal customization and controllability. The fundamental design of the Courtesy light is to keep it as simple as possible as it is important not to overwhelm the driver with many features and buttons as this would lead to a safety hazard as it may be more of a distraction than a tool.   </p>" +
"<p>Even though there are 1.446 billion cars, not all these cars will be the same as there are numerous different cars manufactures with their own unique design. It is important that The Courtesy light has a universal installation method to allow the use of an LED light to operate in any vehicle. If the Courtesy light were only compatible with one specific car model this would drastically reduce the consumer market. A cheap and simple solution for this is the use of Velcro. The buttons will be mounted with the use of Velcro for easy and simple setup with the intention of user friendliness. The use of Velcro will allow the user to choose where the buttons will be set up for convince. Furthermore, as each car is different the use of the Velcro will allow universal compatibility with any car thus, anyone can use the product. Like the buttons the LED display will also use Velcro for the installation.   </p>" +
"<p>The colour of the LED will be green. The colour green has been chosen as green generally represents a positive colour which will help further convey the message to the other drivers. In addition, green was chosen as it will not interfere with the existing lights on the vehicle. If the display were to be orange or red, it may be mistaken for a turn signal or break lights which would intern lead to a safety hazard to other drivers.  When the display is activated, the display will be a static light. If the display were to have flashing lights or cool animations, it would present more of a distraction rather than a message. For this reason, once the button is pressed the message will only display for a short period of time to allow the other driver to recognize the message without impeding the driver's focus. To further ensure safety the LED’s will be set to a minimum legible brightness to prevent excessive light pollution.  </p>" +
"<p>The Courtesy light will also include personal customization by an app which can be downloaded via any Appstore. The app will allow the user to pair with the Courtesy light using Bluetooth. The app will feature language options as well as animations to create variability and improve the aesthetic appeal of the product. The customizable animations allow the user to pick which direction the text will display (e.g top to down, left to right, etc) to best fit the users’ preferences. The language options will allow for different languages to display which intern expands the consumer market and availability across the globe. With the addition of the downloadable app, it allows for the product to be user-friendly while also offering ease of access which intern enhances the user experience. </p>" +
"<p>However, one major drawback of the Courtesy light is that the language options will only include common languages. While common languages will be available there are still many opportunities to expand the language options. A solution to this would be to provide updates for the app to incorporate other languages into the display.   </p>" +
